...
%%--your-code-starts-here--%%
F_man = log(abs(fftshift(fft2(man))));  % replace me
F_man_lowpass = log(abs(fftshift(fft2(man_lowpass))));  % replace me
F_wolft = log(abs(fftshift(fft2(wolft))));  % replace me
F_wolft_highpass = log(abs(fftshift(fft2(wolft_highpass))));  % replace me
%%--your-code-ends-here--%%
